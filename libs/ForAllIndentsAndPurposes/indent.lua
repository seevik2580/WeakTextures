...
if not IndentationLib.revision or revision > IndentationLib.revision then
    ...
    defaultColorTable["local"] = logicColor2
    defaultColorTable["for"] = logicColor2
    defaultColorTable["in"] = logicColor2
    defaultColorTable["and"] = logicColor2
    defaultColorTable["or"] = logicColor2
    defaultColorTable["not"] = logicColor2
    defaultColorTable["while"] = logicColor2
    defaultColorTable["do"] = logicColor2   
    ...
    defaultColorTable["else"] = logicColor2
    defaultColorTable["elseif"] = logicColor2
    defaultColorTable["repeat"] = logicColor2
    defaultColorTable["until"] = logicColor2
    defaultColorTable["nil"] = logicColor2
    defaultColorTable["true"] = logicColor2
    defaultColorTable["false"] = logicColor2
