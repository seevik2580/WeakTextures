...
L.MINIMAP_LEFTCLICK = "Left-click: Open "
L.MINIMAP_RIGHTCLICK = "Right-click: Open Settings"

-- Dynamic/Template Texts
L.ERROR_EVENT_NOT_ALLOWED = "event '%s' is not allowed to be used."
L.PLACEHOLDER_TRIGGER_CODE = "--e.g.   function(e) return UnitHealth('player') < 50 end\n--e.g2. function(e,...) return UnitAffectingCombat(...) end"
...
L.TEXT_ENABLED = "Enable Text Overlay"
L.TEXT_CONTENT = "Text Content"
L.TEXT_FONT = "Font"
L.TEXT_SIZE = "Font Size"
L.TEXT_COLOR = "Text Color"
L.TEXT_OFFSET_X = "X Offset"
L.TEXT_OFFSET_Y = "Y Offset"
...
L.SOUND_ADD = "Add Sound"
L.SOUND_REMOVE = "Remove"
L.SOUND_KEY = "Sound Key"
L.SOUND_PATH = "File Path"
L.SOUND_ENABLED = "Enabled"
L.SOUND_TEST = "Test"
L.SOUND_RANDOM = "Play Random"

L.HEADER_INSTANCES = "Multi-Instance Settings"
L.INSTANCE_ENABLED = "Enable Multi-Instance Mode"
L.INSTANCE_MAX = "Max Instances"
L.INSTANCE_DESC = "Multi-instance mode allows spawning multiple copies of this preset simultaneously. Use CreateInstance(data) in triggers to spawn instances."
L.INSTANCE_WARNING = "Note: Multi-instance mode requires trigger code to call CreateInstance(). Presets will not auto-show when conditions match."
